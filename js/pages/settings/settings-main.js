...
import {AnkiTemplateBuilder} from './anki-template-builder.js';
...
await Application.main(true, async (application) => {
    ...
    const ankiTemplateBuilder = new AnkiTemplateBuilder();
    preparePromises.push(ankiTemplateBuilder.init());
